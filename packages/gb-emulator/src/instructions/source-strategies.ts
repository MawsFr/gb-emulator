import { R8Code, Register8, Registers } from '@/registers/registers.ts'
import { Cpu } from '@/cpu.ts'
import { Immediate8, PointedValue } from '$/src'

export interface SourceStrategy {
    get(): Immediate8 | Register8 | PointedValue
